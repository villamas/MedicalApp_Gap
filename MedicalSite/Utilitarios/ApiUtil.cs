...
namespace MedicalSite.Utilitarios
{
    public class ApiUtil<T>
    {
       ...
       Token);
            ...
            using (StringContent contentData = new StringContent(stringData, System.Text.Encoding.UTF8, "application/json"))
            {
                HttpResponseMessage response = client.PostAsync(Apiurl, contentData).Result;
